...
double dx = L / (num_ceil * 1.0); // шаг по сетке

double T = 3* 3.5e-9; // всего времени
double dt = 3.5e-11; // шаг по времени

//Желаемая концентрация 1e17
double n_2 = 4e13; // сколько частиц моделирует 1 частица
